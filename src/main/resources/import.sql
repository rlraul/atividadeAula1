...
INSERT INTO genero (nome) VALUES ('genero4');

INSERT INTO livro (nome, editora_id, genero_id, autor_id, ano, isbn, cidade_id, valor) VALUES ('Livro1', 1, 1, 1, 2020, 'isbn1', 1, 99.90);
INSERT INTO livro (nome, editora_id, genero_id, autor_id, ano, isbn, cidade_id, valor) VALUES ('Livro2', 2, 2, 2, 2009, 'isbn2', 2, 50.00);
INSERT INTO livro (nome, editora_id, genero_id, autor_id, ano, isbn, cidade_id, valor) VALUES ('Livro3', 3, 3, 3, 1980, 'isbn3', 3, 120.25);
INSERT INTO livro (nome, editora_id, genero_id, autor_id, ano, isbn, cidade_id, valor) VALUES ('Livro4', 4, 4, 5, 2010, 'isbn4', 4, 150.50);